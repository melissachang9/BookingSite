...
@router.post(
    "/tenants/{tenant_slug}/bookings/{booking_id}/payments/wallet-credit",
    response_model=BookingSummaryResponse,
    summary="Apply customer wallet credit to a booking balance",
)
async def apply_wallet_credit_route(
    tenant_slug: str,
    booking_id: str,
